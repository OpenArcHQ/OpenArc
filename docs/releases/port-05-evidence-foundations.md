...
`packages/x402/test/evidence-v2-lane-sync.test.ts` is a compile-time and runtime test. It
keeps shared's copy of the lane exposure types identical to `packages/x402`.
