...
test("both CI gates run the action deployment guard alongside the existing guards", () => {
  ...
  assert.match(releaseGates, /run:\s*node --test scripts\/action-deployment\.test\.mjs/u, "release-gates must run the action deployment guard");
