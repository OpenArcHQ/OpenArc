...
export interface ArcRpcReader {
  call(method: ArcRpcMethod, params: readonly unknown[], lease: SourceLease, signal: AbortSignal): Promise<unknown>;
}

export class ArcRpcClient implements ArcRpcReader {
  constructor(private readonly provider: BoundedProviderClient) {}

  async call(method: ArcRpcMethod, params: readonly unknown[], lease: SourceLease, signal: AbortSignal): Promise<unknown> {
