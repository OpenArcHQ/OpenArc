...
export const ROUTE_CLASSES = ["health", "readiness", "capabilities", "metrics", "arc_account", "arc_transaction", "agent_registry", "agent_job", "gateway_transfer", "disabled_source", "not_found", "test_source"] as const;
